...
class BSCWallet extends skydapp_common_1.EventContainer {
    constructor() {
        super();
        ...
        if (this.existsInjectedProvider === true) {
            ...
            this.walletConnectProvider = new web3_provider_1.default({ rpc: "https://bsc-dataseed.binance.org" });
...
exports.default = new BSCWallet();
//# sourceMappingURL=BSCWallet.js.map