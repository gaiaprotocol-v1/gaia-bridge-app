...
const ERC20Contract_1 = __importDefault(require("./bsc-standard/ERC20Contract"));
class BSCInjeolmiContract extends ERC20Contract_1.default {
    constructor() {
        super("0xf258F061aE2D68d023eA6e7Cceef97962785c6c1", WrappedInjeolmi_json_1.default.abi, [
            "SetSigner",
            "SendOverHorizon",
            "ReceiveOverHorizon",
        ]);
        BSCWallet_1.default.toss("connect", this);
    }
    async loadAddress() {
        return await BSCWallet_1.default.loadAddress();
    }
    async connect() {
        await BSCWallet_1.default.connect();
    }
    addTokenToWallet() {
        BSCWallet_1.default.addToken(this.address, "IJM", 18, "https://tteok.org/images/injeolmi.png");
    }
...
exports.default = new BSCInjeolmiContract();
//# sourceMappingURL=BSCInjeolmiContract.js.map