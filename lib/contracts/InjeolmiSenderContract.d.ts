...
declare class InjeolmiSenderContract extends KlaytnContract implements InjeolmiSenderInterface {
    constructor();
    private watch;
...
declare const _default: InjeolmiSenderContract;
export default _default;
//# sourceMappingURL=InjeolmiSenderContract.d.ts.map