...
const PaxForm_1 = __importDefault(require("./PaxForm"));
const PaxSended_1 = __importDefault(require("./PaxSended"));
class PaxSwaper extends skydapp_browser_1.DomNode {
    constructor() {
        super(".pax-swaper");
        this.loadHistoryNonce = 0;
        this.append((0, skydapp_browser_1.el)(".form-container", (this.fromForm = new PaxForm_1.default(this, 8217, true)), (0, skydapp_browser_1.el)("img.arrow", { src: "/images/icn/arrow-right.svg", height: "50", alt: "arrow-right" }), (this.toForm = new PaxForm_1.default(this, 1))), (0, skydapp_browser_1.el)(".fee-container", (0, skydapp_browser_1.el)(".content", (0, skydapp_browser_1.el)("h3", "Fees")), (0, skydapp_browser_1.el)("p", "0 PAX")), (0, skydapp_browser_1.el)(".received-container", (0, skydapp_browser_1.el)("h3", "Estimated Received"), (0, skydapp_browser_1.el)("p", "0 PAX")), (0, skydapp_browser_1.el)(".warning", (0, skydapp_browser_1.el)("img", { src: "/images/icn/warning.svg", alt: "warning icon" }), (0, skydapp_browser_1.el)("p", "브릿지 이용 시 양 체인에 가스비가 발생됩니다.\n보내는 체인이 이더리움일 경우 32컨펌 후 Recieve 서명이 필요합니다")), (0, skydapp_browser_1.el)(".button-container", (0, skydapp_browser_1.el)("button", "Approve", { click: () => { } }), (0, skydapp_browser_1.el)("button", "Transfer")), (0, skydapp_browser_1.el)(".history", (0, skydapp_browser_1.el)("h2", "History"), (0, skydapp_browser_1.el)("p", "트랜잭션이 한번 시작되면 되돌릴 수 없습니다.\nTransfer후 Recieve 까지 완료되어야 체인 간 전송이 완료됩니다"), (0, skydapp_browser_1.el)(".sended-title", (0, skydapp_browser_1.el)("h3", "From Chain"), (0, skydapp_browser_1.el)("h3", "To Chain"), (0, skydapp_browser_1.el)("h3", "Amount"), (0, skydapp_browser_1.el)("h3", "Status")), (this.sendedList = (0, skydapp_browser_1.el)("table.sended-list"))));
    ...
    addSended(sender, receiver, sendId) {
        if (this.fromForm.sender !== undefined &&
            this.toForm.sender !== undefined) {
            new PaxSended_1.default(this.fromForm.sender, this.toForm.sender, this.fromForm.chainId, this.toForm.chainId, sender, receiver, sendId.toNumber(), async () => {
                if (this.fromForm.sender !== undefined) {
...
exports.default = PaxSwaper;
//# sourceMappingURL=PaxSwaper.js.map