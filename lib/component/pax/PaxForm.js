...
class PaxForm extends skydapp_browser_1.DomNode {
    constructor(swaper, chainId, isFrom = false) {
        ...
        this.append((0, skydapp_browser_1.el)(".chain", this.chainIcon = (0, skydapp_browser_1.el)("img", { src: "/images/logo/pax.png", alt: "chain logo" }), isFrom ? (0, skydapp_browser_1.el)("p", "FROM") : (0, skydapp_browser_1.el)("p.help-text", "TO"), this.chainSelect = (0, skydapp_browser_1.el)("select", (0, skydapp_browser_1.el)("option", "Klaytn", {
            value: "8217",
...
exports.default = PaxForm;
//# sourceMappingURL=PaxForm.js.map