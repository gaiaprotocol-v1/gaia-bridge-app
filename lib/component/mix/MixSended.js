...
class MixSended extends skydapp_browser_1.DomNode {
    ...
    async load() {
        ...
        this.empty().append((0, skydapp_browser_1.el)(".history-item", (0, skydapp_browser_1.el)("p", `${await this.getChainName(this.fromChain)}`), (0, skydapp_browser_1.el)("p", `${await this.getChainName(this.toChain)}`), (0, skydapp_browser_1.el)("p", `${await this.getFormatting(sended)} MIX`), (0, skydapp_browser_1.el)("p", received === true ? (0, skydapp_browser_1.el)(".done", "전송 완료") : (0, skydapp_browser_1.el)("a.retry-button", "재시도", {
            click: () => this.retry(),
        }))));
    }
...
exports.default = MixSended;
//# sourceMappingURL=MixSended.js.map