...
import Form from "./MixForm";
import Sended from "./MixSended";

export default class MixSwaper extends DomNode {
            ...
            if (receiver === _receiver) {
                try {
                    const result = await superagent
                        .get(
                            `https://api.gaiabridge.com/mix/signsend?receiver=${receiver}&fromChain=${this.fromForm.chainId
